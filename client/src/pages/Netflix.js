...
//
    ...
    return (
        ...
        <div className="bg-black h-screen relative overflow-hidden">
            <img src={backgroundImage} alt="" className="object-cover w-full h-full absolute inset-0  brightness-50" />
            ...
            <div className="absolute inset-0 flex flex-col items-start justify-center pl-8">
                ...
                <button onClick={()=>history("/player")}className="bg-white tex-black mb-2">
                    <svg
                ...
                <button className="bg-white tex-black">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
